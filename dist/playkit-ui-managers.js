...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".side-panel_cktsP {\n  visibility: hidden;\n}\n\n.active_TYqXV {\n  visibility: visible;\n}", "",{"version":3,"sources":["webpack://./src/services/side-panels/ui/panel-item-wrapper/panel-item-wrapper.component.scss"],"names":[],"mappings":"AAAA;EACE,kBAAA;AACF;;AAEA;EACE,mBAAA;AACF","sourcesContent":[".side-panel {\n  visibility: hidden;\n}\n\n.active {\n  visibility: visible;\n}\n"],"sourceRoot":""}]);
// Exports
...
class ItemWrapper {
    constructor(item, player, onClick) {
        ...
        if (item.iconComponent)
            this.injectIconComponent(onClick);
    }
    activate() {
        ...
        this.removeIconComponentFn = this.player.ui.addComponent({
            ...
            get: function MyComponent() {
                return ((0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(_ui_icon_wrapper_icon_wrapper_component__WEBPACK_IMPORTED_MODULE_3__.IconWrapper, { ref: componentRef, onClick: () => {
                    ...
                    (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(IconComponent, { isActive: this.isActive })));
            }
        });
    }
